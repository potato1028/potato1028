...
### 🚀 What I'm Up To
- 🔭 **Current Project**: 현재 나만의 **플랫폼 게임**을 기획하고 개발하고 있어요. 🎮
- 🌱 **Learning**: **Unity**의 심화 기능과 **C++ 객체 지향 프로그래밍**의 핵심 원리를 깊게 공부하고 있습니다.
- 🎯 **Goal**: C와 C++ 언어를 완벽히 이해하고 활용하는 **C/C++ 마스터**가 되는 것을 목표로 하고 있습니다.

### 🛠 My Background
- 🎮 **Game Dev**: Unity 엔진을 활용한 클라이언트 개발에 익숙합니다.
